...
Source0  : https://download.kde.org/stable/frameworks/5.102/portingAids/kjsembed-5.102.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.102/portingAids/kjsembed-5.102.0.tar.xz.sig
Summary  : Embedded JS
...
%prep
%setup -q -n kjsembed-5.102.0
cd %{_builddir}/kjsembed-5.102.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1675353152
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5JsEmbed.so.5.102.0
