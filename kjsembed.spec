...
Source0  : https://download.kde.org/stable/frameworks/5.71/portingAids/kjsembed-5.71.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.71/portingAids/kjsembed-5.71.0.tar.xz.sig
Summary  : Embedded JS
...
%prep
%setup -q -n kjsembed-5.71.0
cd %{_builddir}/kjsembed-5.71.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1592248940
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kjsembed-5.71.0/COPYING.LIB %{buildroot}/usr/share/package-licenses/kjsembed/9a1929f4700d2407c70b507b3b2aaf6226a9543c
pushd clr-build
%make_install
popd
%find_lang kjsembed5
...
/usr/lib64/libKF5JsEmbed.so.5.71.0
