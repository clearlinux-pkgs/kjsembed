...
%prep
%setup -q -n kjsembed-5.111.0
cd %{_builddir}/kjsembed-5.111.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1699591654
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF5JsEmbed.so.5.111.0
/usr/lib64/libKF5JsEmbed.so.5
/usr/lib64/libKF5JsEmbed.so.5.111.0
