...
Version  : 5.104.0
Release  : 150
URL      : https://download.kde.org/stable/frameworks/5.104/portingAids/kjsembed-5.104.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.104/portingAids/kjsembed-5.104.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.104/portingAids/kjsembed-5.104.0.tar.xz.sig
Summary  : Embedded JS
...
%prep
%setup -q -n kjsembed-5.104.0
cd %{_builddir}/kjsembed-5.104.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1679586295
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5JsEmbed.so.5.104.0
