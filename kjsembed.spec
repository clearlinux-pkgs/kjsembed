...
Source0  : https://download.kde.org/stable/frameworks/5.59/portingAids/kjsembed-5.59.0.tar.xz
Source99 : https://download.kde.org/stable/frameworks/5.59/portingAids/kjsembed-5.59.0.tar.xz.sig
Summary  : Embedded JS
...
export LANG=C
export SOURCE_DATE_EPOCH=1560022313
mkdir -p clr-build
pushd clr-build
export AR=gcc-ar
...
/usr/lib64/libKF5JsEmbed.so.5.59.0
