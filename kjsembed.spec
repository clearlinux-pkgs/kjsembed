...
Source0  : https://download.kde.org/stable/frameworks/5.56/portingAids/kjsembed-5.56.0.tar.xz
Source99 : https://download.kde.org/stable/frameworks/5.56/portingAids/kjsembed-5.56.0.tar.xz.sig
Summary  : Embedded JS
...
export LANG=C
export SOURCE_DATE_EPOCH=1552148278
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5JsEmbed.so.5.56.0
