...
%prep
%setup -q -n kjsembed-5.87.0
cd %{_builddir}/kjsembed-5.87.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1634428141
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kjsembed-5.87.0/COPYING.LIB %{buildroot}/usr/share/package-licenses/kjsembed/9a1929f4700d2407c70b507b3b2aaf6226a9543c
pushd clr-build
%make_install
popd
%find_lang kjsembed5
...
/usr/lib64/libKF5JsEmbed.so.5.87.0
